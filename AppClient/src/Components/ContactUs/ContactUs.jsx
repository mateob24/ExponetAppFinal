...
const ContactUs = () => {
    return (
        <div className="flex min-h-full flex-1 flex-col justify-center  items-center px-6 py-12 bg-white lg:px-8 container-contactus">
            <h1 className="mt-2 mb-4 text-center font-bold leading-9 text-gray-900 title-contactus">Contáctanos</h1>
            <form className="w-2/5 py-8 px-4 flex flex-col items-center justify-center space-y-6 rounded-md shadow-sm bg-gray-50">
                <div className='min-w-full'>
                    ...
                    <input
                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 input-contactus"
                        id="name"
                        type="text"
                        placeholder="Nombre"
                    />
                ...
                <div className='min-w-full'>
                    ...
                    <textarea
                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 resize-none placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 input-contactus"
                        id="message"
                        placeholder="Mensaje"
                        rows="6"
                    ></textarea>
